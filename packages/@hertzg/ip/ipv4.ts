 ...
 * RFC 1035 §3.5 specifies. For the IPv6 counterpart see `ipv6ToArpa`, and for
 * one that takes either version see `ipToArpa`.
 *
 ...
 * ```ts
 * import { assertEquals } from "@std/assert";
 * import { ipv4ToArpa, parseIpv4 } from "@hertzg/ip/ipv4";
 *
